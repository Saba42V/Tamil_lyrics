# Tamil lyrics corpus Based on previous reserchers source Dataset(Dhivya Chinnappa and Praveenraj Dhandapani) below research is conducted and addiing new dataset with additional columns.
